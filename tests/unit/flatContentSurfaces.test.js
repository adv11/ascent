...
const OVERLAY_SELECTOR_PATTERN =
  /(^|[\s,.])(modal-card|dropdown-menu|dropdown-scrim|custom-select-scrim|floating-scrim|command-palette-card|item-panel|tooltip-bubble|toast|daily-todo-panel|tour-popover|settings-section|settings-guest-card|landing-mock-card|feature-card|step-card|template-card-picking-overlay|panel-overlay|landing-nav)([\s,.:{[]|$)/;
