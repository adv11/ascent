...
## Corpus Check
- 380 files · ~462,209 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1831 nodes · 3945 edges · 181 communities (127 shown, 54 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9df8dbc9`
...
Cohesion: 0.26
Nodes (11): RFC-5322, authShell(), buildResetForm(), buildSignInForm(), renderSignIn(), signInAsGuest(), renderSignUp(), attachFieldValidationIcon() (+3 more)
...
Cohesion: 0.11
Nodes (37): authErrorMessage(), isInstallable(), listeners, onInstallabilityChange(), promptInstall(), getAnimationsOff(), setAnimationsOff(), setTextSize() (+29 more)
...
Cohesion: 0.16
Nodes (22): exportFileBaseName(), createAvatar(), initialsFor(), createDropdown(), openMyReports(), buildAccountMenu(), createSidebar(), NAV_ITEMS (+14 more)
...
Cohesion: 0.27
Nodes (6): DECORATIVE_ICON_SHAPES, VALID_SIZES, createProgressRing(), iconSvg(), svgEl(), svgIcon()
...
Cohesion: 0.16
Nodes (15): attachTooltip(), renderFilterChips(), buildHeroStatement(), dominantPriorityFor(), formatLongDate(), ORDINAL_DAY_WORDS, PRIORITIES, RANGE_OPTIONS (+7 more)
...
Cohesion: 0.33
Nodes (8): createAuthMarketingPanel(), ICONS, iconSvg(), VALUE_PROPS, brandGlyph(), createBrandIcon(), createBrandMark(), createBrandWordmark()
...
Cohesion: 0.33
Nodes (4): createNotificationBadge(), debounce(), escapeHtml(), isValidUrl()
...
Cohesion: 0.23
Nodes (11): authApi, activeRoadmapTitle(), copyToClipboard(), openShareRoadmapModal(), renderShareRow(), shareUrl(), ensureRoot(), showToast() (+3 more)
...
Cohesion: 0.16
Nodes (12): openBuildYourOwnGuide(), bindCommandPaletteShortcut(), fuzzyMatch(), openCommandPalette(), attachFocusTrap(), openModal(), createNotificationBell(), createTopbar() (+4 more)
...
Cohesion: 0.10
Nodes (26): getReviewDueItems(), groupReviewDueItemsByTag(), isReviewDue(), animatePhaseBody(), applySectionPlan(), buildSectionRows(), collectAllMountedRows(), collectPrunableRowsFromBottom() (+18 more)
...
### Community 169 - "guestDataRiskNudge.js"
Cohesion: 0.42
...
Cohesion: 0.20
Nodes (10): openChangelogDrawer(), renderEntryItem(), renderVersionGroup(), TYPE_LABELS, createEmptyState(), createIcon(), ICON_SHAPES, VALID_SIZES (+2 more)

### Community 174 - "myReports.js"
Cohesion: 0.39
Nodes (7): listenMyReports(), createDecorativeIcon(), buildMyReportsView(), buildReportRow(), formatDate(), STATUS_LABEL, TYPE_ICON

### Community 175 - "dashboard.test.js"
Cohesion: 0.29
Nodes (5): items(), build(), buildWrapper(), format(), mount()

### Community 176 - "CI — PR Quality Gate workflow"
Cohesion: 0.33
...
Cohesion: 0.18
Nodes (13): checkResourceLink(), LINK_CHECK_MESSAGES, LINK_CHECK_STATUS, openItemPanel(), renderInlineResources(), detectLinkType(), LINK_TYPE_META, LINK_TYPES (+5 more)
...
## Knowledge Gaps
- **335 isolated node(s):** `name`, `version`, `private`, `license`, `type` (+330 more)
...
- **Why does `el()` connect `Brand & Auth Marketing Panel` to `Analytics Engine`, `Backup/Export Schema + ICS Export`, `notificationBell.js`, `Import Validation & Corruption Detection`, `Review Scheduling & Celebration State`, `reminderScheduler.js`, `showToast`, `topbar.js`, `Share Card Canvas Rendering`, `Time Tracking & Daily Todo Panel`, `Command Palette & Router`, `LocalStorage Keys & Filter Preferences`, `roadmapComparisonModal.js`, `dailyTodoPanel.js`, `CSP/SRI Security ADRs`, `createSelect`, `App Bootstrap (main.js)`, `dashboard.js`, `backupReminderBanner.js`, `Hosting/Anonymous-User/Feedback ADRs`, `Theme Service`, `createIcon`, `myReports.js`, `CI Workflow Jobs`, `itemPanel.js`, `Monetization Decision (one-time purchase)`, `Tabs Component`, `Issue Tracker Sync Workflow`, `Feedback Widget Tests`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `KEYS` connect `Confirm Dialog & Sign-out Utils` to `App Bootstrap (main.js)`, `dashboard.js`, `Roadmap Templates Registry`, `Hosting/Anonymous-User/Feedback ADRs`, `notificationBell.js`, `Import Validation & Corruption Detection`, `Brand & Auth Marketing Panel`, `Auth & Account Guards`, `reminderScheduler.js`, `migration.js`, `LocalStorage Adapter`, `uiPreferences.js`, `topbar.js`, `Command Palette & Router`, `dailyTodoPanel.js`, `Tabs Component`?**
